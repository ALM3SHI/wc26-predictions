...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-white pt-8 pb-24 px-4 sm:px-6 relative">
      <div className="max-w-xl mx-auto relative z-10">
        <h1 className="font-display font-black text-3xl mb-8 text-gray-900">Settings</h1>
        
        <GlassCard className="p-6 flex items-center justify-between bg-white border border-gray-200 shadow-sm rounded-2xl">
